            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <p className="mt-6 text-lg text-gray-700">Founded on the principles of hard work and integrity, Keza Logistics has grown from a small family operation into a leading freight carrier. We combine traditional values with modern technology to provide unparalleled service. Our roots are in the Midwest, but our reach is nationwide.</p>
                        <h3 className="mt-12 text-2xl font-bold uppercase text-brand-black">Service Area: Midwest Focus, National Reach</h3>
                        <p className="mt-4 text-lg text-gray-700">Headquartered in the heartland of IOWA, we offer comprehensive coverage across all 48 contiguous states. Our strategic location ensures efficient transit times and competitive pricing, whether your destination is regional or coast-to-coast.</p>
                    </div>
                    <div>
