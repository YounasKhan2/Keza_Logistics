...
<section id="home" className="relative h-screen min-h-[600px] w-full pt-0 ">
    ...
    <div className="relative h-full flex flex-col items-center justify-center text-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 max-w-3xl text-white">
            <div className="text-blue-400 text-xl md:text-6xl font-extrabold uppercase tracking-widest mb-2">
                Keza Logistics
            </div>
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-wider">Driven by Excellence</h1>
